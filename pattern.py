...
test_pattern = [3, 8, 3, 9, 6, 0, 1, 2, 7, 5, 3, 4, 8, 3, 9, 1, 8, 5, 0,0, 5, 5 ]

test_pattern = [5, 3, 4, 8, 3, 9, 1, 8, 5, 0, 0, 5, 5, 0 ]


# pattern = test_pattern[::-1]
...
hot_picks, draw_number_count = calculate_pattern(pattern)
